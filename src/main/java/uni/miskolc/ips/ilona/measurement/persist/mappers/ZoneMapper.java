...
public interface ZoneMapper {
  /**
   * Selects all zones from the collection of zones. Returns all zones, or an empty collection.
   *
   ...
   *
   * @param name The name of the searched zone.
   ...
   *
   * @param id The ID of the searched zone.
