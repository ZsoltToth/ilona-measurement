...
public interface PositionService {
     ...
     * @throws DatabaseUnavailableException Triggers if the connection with the database cannot be
     *     established.
     * @throws InconsistentPositionException Triggers if the integrity of the data is not valid.
     */
    void createPosition(Position position)
            throws DatabaseUnavailableException, InconsistentPositionException;

    /**
     * Retrieves a collection of position data from the database.
     *
     * @return Returns the collection of position data.
     * @throws DatabaseUnavailableException Triggers if the connection with the database cannot be
     *     established.
     */
     ...
     *     established.
     * @throws InconsistentPositionException Triggers if the integrity of the data is not valid.
     * @throws PositionNotfoundException Occurs, when the position does not exists.
     */
     ...
     *
     * @param posid An unique uniform identifier for the position.
