...
public class PositionManagerServiceImpl implements PositionService {
   ...
   *
   * @param position is the given position which should be recorded.
   */
  ...
  /**
   * The updatePosition method modify the given Position in the database based on the UUID of the
   * Position.
   *
  ...
  /**
   * The deletePositin method delete the Position from the database, which is the same Position with
   * the given.
   *
