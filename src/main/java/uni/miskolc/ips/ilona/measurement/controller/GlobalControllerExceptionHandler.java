 ...
 *
 * <p>If a database is not available the services should return with Insufficient storege status
 * code (507).
 *
 * <p>If there is a conversion problem during the marshalling of JSON messages then controllers
 * return with unsupported media type satus code (415).
 *
 * @author tothzs
 */
@ControllerAdvice
public class GlobalControllerExceptionHandler {
  ...
  public void databaseUnavailableExceptionHandler(Exception ex) {
    LOG.fatal(ex.getMessage());
  }

  @ResponseStatus(
      value = HttpStatus.UNSUPPORTED_MEDIA_TYPE,
      reason = "Data conversion was unsuccessful.")
  @ExceptionHandler(DatatypeConfigurationException.class)
  public void datatypeConfigurationExceptionHandler(Exception ex) {
