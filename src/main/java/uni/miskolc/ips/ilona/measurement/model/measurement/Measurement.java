...
public class Measurement {
  ...
  /** It represents a universally unique identifier, which identifies the measurement. */
  private UUID id;
  ...
  /**
   * Represents the measurement of the bluetooth sensor and calculates the distance of two bluetooth
   * sensor measurement.
   */
   ...
   * @param rfidTags uses electromagnetic fields to automatically identify and track tags attached
   *     to objects.
   */
   ...
   *
   * @param magnetometer sets magnetometer values.
   */
   ...
   *
   * @param bluetoothTags sets the measured and distance data.
   */
   ...
   * UUID setter method.
   *
   * @param id sets the measurement identifier.
   */
   ...
   *
   * @param timestamp sets the current timestamp measured in milliseconds.
   */
   ...
   *
   * @return position gets the position based on the coordinate, zone and UUID attributes.
   */
   ...
   *
   * @param position sets the position based on the coordinate, zone and UUID attributes.
   */
