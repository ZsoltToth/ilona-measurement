...
public class SetupIntegrationTest {
  ...
  /**
   * It checks the existence of the required script files and properties. The tests are ignored, if
   * anything is missing.
   *
   * <p>It also set up the database and create tables.
   */
  @BeforeClass
  ...
  /** It instantiate the DAO object and insert the test data into the test database. */
  @Before
  public void setUp() {
    /* INSERT TEST RECORDS */
    try {
