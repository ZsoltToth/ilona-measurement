...
public class BluetoothTagsTest {
  ...
  public void testDistanceFromItselfIsZero() {
    Set<String> data =
        new HashSet<String>(
            Arrays.asList(new String[] {"001060AA36F8", "001060AA36F4", "001060AA36F2"}));
  ...
  public void testDistanceReflexivity() {
    ...
    Set<String> data2 =
        new HashSet<String>(
            Arrays.asList(new String[] {"001060AA36A8", "001060AA36D4", "001060AA36F2"}));
  ...
  public void testDistanceDifferent() {
    Set<String> data1 =
        new HashSet<String>(
            Arrays.asList(new String[] {"011060AA36F8", "011060AA36F4", "011060AA36F2"}));
    BluetoothTags bluetooth1 = new BluetoothTags(data1);
    Set<String> data2 =
        new HashSet<String>(
            Arrays.asList(new String[] {"001060AA36F8", "001060AA36F4", "001060AA36F2"}));
  ...
  public void testDistance() {
    Set<String> data1 =
        new HashSet<String>(
            Arrays.asList(
                new String[] {"001060AA36F8", "001060AA36F4", "001060AA36F2", "011060AA36C8"}));
    BluetoothTags bluetooth1 = new BluetoothTags(data1);
    Set<String> data2 =
        new HashSet<String>(
            Arrays.asList(
                new String[] {"001060AA36F8", "001060AA36D4", "001060AA36F2", "011060AA36C8"}));
    BluetoothTags bluetooth2 = new BluetoothTags(data2);
    double expected = 0.4;
    double actual = bluetooth1.distance(bluetooth2);
    assertEquals(expected, actual, 1e-10);
